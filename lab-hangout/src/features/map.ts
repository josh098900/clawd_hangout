...
const VIA: Partial<Record<RoomId, RoomId>> = {
  ...
  park: 'parkstn', parkstn: 'park', diner: 'dinerstn', dinerstn: 'diner', karts: 'kartstn', kartstn: 'karts', station: 'spacewalk', moon: 'moonbase', moonbase: 'moon', wing: 'lab', reactor: 'wing', chem: 'wing',
};
...
const LOOK_X: Partial<Record<RoomId, number>> = { plaza: 560, roof: 1500, station: 900, lofts: 495, pier: 700, park: 700, karts: 600, moon: 700, diner: 500, reactor: 1000, chem: 636, subway: 600, parkstn: 600, dinerstn: 600, kartstn: 600 };
