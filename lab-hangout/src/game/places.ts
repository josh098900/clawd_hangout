...
export const EXPLORE: RoomId[] = ['lab', 'den', 'roof', 'plaza', 'arcade', 'cinema', 'stage', 'subway', 'crypt', 'lofts', 'pier', 'park', 'diner', 'karts', 'station', 'spacewalk', 'moon', 'moonbase', 'wing', 'reactor', 'chem'];
