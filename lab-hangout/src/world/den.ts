...
function build(this: Room): void {
  bake(this.bg.getContext('2d')!, () => {
    ...
    // (a short fridge, so it sits under the status screen instead of behind it)
    r(204, 360, 34, 70, [200, 206, 210]); r(206, 362, 30, 68, [232, 236, 238]); r(206, 382, 30, 2, [180, 186, 190]); r(230, 367, 2, 10, [150, 156, 160]); r(230, 390, 2, 22, [150, 156, 160]);
